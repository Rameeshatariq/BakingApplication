...
import com.example.cv.baker_app.ConnectionStateMonitor;
import com.example.cv.baker_app.ConnectivityReceiver;
import com.example.cv.baker_app.GridAutofitLayoutManager;
import com.example.cv.baker_app.MyApplication;
import com.example.cv.baker_app.R;
import com.example.cv.baker_app.databinding.ActivityMainBinding;
...
import com.example.cv.baker_app.widgets.RecipeWidgetProvider;
...
import static com.example.cv.baker_app.utlis.Constant.GRID_COLUMN_WIDTH;
...
public class MainActivity extends AppCompatActivity implements RecipesAdapter.RecipeAdapterOnClickHandler,
    ...
    private void initAdapter() {
        ...
        mMainBinding.rv.setAdapter(mRecipesAdapter);
    }
