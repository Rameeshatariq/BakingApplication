...
package com.example.cv.baker_app.widgets;
...
import com.example.cv.baker_app.model.Ingredient;
import com.example.cv.baker_app.model.Recipe;
import com.example.cv.baker_app.model.Step;
import com.example.cv.baker_app.ui_design.detail.DetailActivity;
import com.example.cv.baker_app.ui_design.main.MainActivity;
import com.example.cv.baker_app.utlis.BakingUtils;

import java.util.List;

import static com.example.cv.baker_app.utlis.Constant.DEFAULT_INTEGER;
import static com.example.cv.baker_app.utlis.Constant.DEFAULT_INTEGER_FOR_SERVINGS;
import static com.example.cv.baker_app.utlis.Constant.DEFAULT_STRING;
import static com.example.cv.baker_app.utlis.Constant.EXTRA_RECIPE;
import static com.example.cv.baker_app.utlis.Constant.WIDGET_PENDING_INTENT_ID;
