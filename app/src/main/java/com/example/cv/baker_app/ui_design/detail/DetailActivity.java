...
import com.example.cv.baker_app.ui_design.mediaplayer.PlayerActivity;
import com.example.cv.baker_app.ui_design.mediaplayer.StepDetailFragment;
import com.example.cv.baker_app.ui_design.desiredListingredients.DesiredIngredientActivity;
import com.squareup.picasso.Picasso;

import static com.example.cv.baker_app.utlis.Constant.EXTRA_RECIPE;
import static com.example.cv.baker_app.utlis.Constant.EXTRA_STEP_INDEX;
...
public class DetailActivity extends AppCompatActivity implements StepsFragment.OnStepClickListener {
    ...
    private void startShoppingActivity() {
        Intent intent = new Intent(this, DesiredIngredientActivity.class);
        startActivity(intent);
    }
