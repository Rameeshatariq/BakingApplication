...
import com.example.cv.baker_app.databinding.RecipesListItemLayoutBinding;
...
import static com.example.cv.baker_app.utlis.Constant.RECIPE_IMAGE_PADDING;

/**
 * {@link RecipesAdapter} exposes a list of recipes to a {@link RecyclerView}
 */
public class RecipesAdapter extends RecyclerView.Adapter<RecipesAdapter.RecipeViewHolder> {
     ...
     */
    public RecipesAdapter(List<Recipe> recipeList, RecipeAdapterOnClickHandler onClickHandler) {
    ...
    public RecipeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        RecipesListItemLayoutBinding recipeItemBinding = DataBindingUtil
                .inflate(layoutInflater, R.layout.recipes_list_item_layout, parent, false);
    ...
    public class RecipeViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private RecipesListItemLayoutBinding mRecipeItemBinding;
         ...
         */
        public RecipeViewHolder(RecipesListItemLayoutBinding recipeItemBinding) {
