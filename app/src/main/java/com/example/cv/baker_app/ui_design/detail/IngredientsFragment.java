...
import com.example.cv.baker_app.databinding.FragmentIngredientsListBinding;
...
public class IngredientsFragment extends Fragment implements
    ...
    private FragmentIngredientsListBinding mIngredientBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mDb = RecipesDatabase.getInstance(this.getContext());
    ...
    public void onIngredientClick(final int ingredientIndex) {
        ...
        final DesiredIngredientsListEntry currentDesiredIngredientsListEntry = getCurrentShoppingListEntry(ingredientIndex);
        ...
        if (!mIndices.contains(ingredientIndex)) {
            ...
            AppExecutors.getInstance().diskIO().execute(new Runnable() {
                @Override
                public void run() {
                    mDb.recipeDao().insertIngredient(currentDesiredIngredientsListEntry);
                }
            });
     ...
     * @param ingredientIndex Position of the ingredient in the list
     */
    private DesiredIngredientsListEntry getCurrentShoppingListEntry(int ingredientIndex) {
        // Get the ingredient
        Ingredient ingredient = mRecipe.getIngredients().get(ingredientIndex);

        return new DesiredIngredientsListEntry(mRecipe.getName(), ingredient.getQuantity(),
