...
import com.example.cv.baker_app.databinding.StepsListItemLayoutBinding;
...
public class StepsAdapter extends RecyclerView.Adapter<StepsAdapter.StepsViewHolder> {
    ...
    public StepsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        StepsListItemLayoutBinding stepsItemBinding = DataBindingUtil
                .inflate(layoutInflater, R.layout.steps_list_item_layout, parent, false);
    ...
    public class StepsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private StepsListItemLayoutBinding mStepsItemBinding;
         ...
         */
        public StepsViewHolder(StepsListItemLayoutBinding stepsItemBinding) {
