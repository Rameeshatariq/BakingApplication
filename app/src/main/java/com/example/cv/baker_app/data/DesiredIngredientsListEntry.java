...
public class DesiredIngredientsListEntry {
     ...
     */
    @Ignore
    public DesiredIngredientsListEntry(String recipeName, double quantity, String measure, String ingredient, int index) {
     ...
     */
    public DesiredIngredientsListEntry(int id, String recipeName, double quantity, String measure, String ingredient, int index) {
        this.id = id;
        this.recipeName = recipeName;
        this.quantity = quantity;
        this.measure = measure;
