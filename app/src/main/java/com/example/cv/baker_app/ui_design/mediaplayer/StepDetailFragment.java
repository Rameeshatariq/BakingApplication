...
package com.example.cv.baker_app.ui_design.mediaplayer;
...
import com.example.cv.baker_app.databinding.FragmentStepDetailBinding;
import com.example.cv.baker_app.model.Recipe;
import com.example.cv.baker_app.model.Step;
...
import static com.example.cv.baker_app.utlis.Constant.EXTRA_RECIPE;
import static com.example.cv.baker_app.utlis.Constant.FAST_FORWARD_INCREMENT;
import static com.example.cv.baker_app.utlis.Constant.PLAYER_PLAYBACK_SPEED;
import static com.example.cv.baker_app.utlis.Constant.REWIND_INCREMENT;
import static com.example.cv.baker_app.utlis.Constant.SAVE_STEP;
import static com.example.cv.baker_app.utlis.Constant.START_POSITION;
import static com.example.cv.baker_app.utlis.Constant.STATE_CURRENT_WINDOW;
import static com.example.cv.baker_app.utlis.Constant.STATE_PLAYBACK_POSITION;
import static com.example.cv.baker_app.utlis.Constant.STATE_PLAY_WHEN_READY;
import static com.example.cv.baker_app.utlis.Constant.STATE_STEP_INDEX;
